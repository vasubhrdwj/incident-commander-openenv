# Teaching a 3B model to be an on-call engineer (and what it took to actually train it)
...
The result on the third try:

| Task | Baseline | Post-SFT | Δ |
|---|---:|---:|---:|
| Easy | 0.956 | 0.761 | −0.195 |
| Medium | 0.775 | 0.790 | +0.015 |
| **Hard** | **0.347** | **0.895** | **+0.548** |
| **Macro-mean** | **0.693** | **0.815** | **+0.122** |

**Hard task more than doubled.** Went from worst-scoring task to best-scoring task in the project. Three eval seeds, all 0.895, deterministic, zero parse errors. That is the headline.
...
- **Reproducible Colab:** [`training/train_colab.ipynb`](https://huggingface.co/spaces/vasubhrdwj/incident-commander-openenv/blob/main/training/train_colab.ipynb)
- **Smoke-test:** `openenv validate --url https://vasubhrdwj-incident-commander-openenv.hf.space`
